...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sat Sep 20 17:54:09 UTC 2014
 * Configured by     : Debian Project
 * Target system     : linux hartmann 3.15-trunk-armmp-lpae #1 smp debian 3.15.1-1~exp1 (2014-06-20) armv7l gnulinux 
 */
 ...
 */
#define OSNAME "linux"		/**/
#define OSVERS "3.15-trunk-armmp-lpae"		/**/
 ...
 */
#define PERL_INC_VERSION_LIST "5.20.0",0		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/arm-linux-gnueabi/perl/5.20.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/arm-linux-gnueabi/perl/5.20.1"		/**/
 ...
 */
#define SITELIB "/usr/local/share/perl/5.20.1"		/**/
#define SITELIB_EXP "/usr/local/share/perl/5.20.1"		/**/
#define SITELIB_STEM ""		/**/
